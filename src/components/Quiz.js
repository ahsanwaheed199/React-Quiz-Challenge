...
const Quiz = () => {
  ...
  const handleOptions = (e) => {
    e.target.value && setDisableOption(true);
    if (currentData.find((corAns) => corAns.correct_answer == e.target.value)) {
      setCorrect("Correct!");
      ...
      <S.Content>
        ...
        {currentPage < 20 && (
          <S.Pages>
            ...
            <S.Button onClick={disableOptions == true ? onNext : undefined}>
              Next
            </S.Button>
          </S.Pages>
        )}
